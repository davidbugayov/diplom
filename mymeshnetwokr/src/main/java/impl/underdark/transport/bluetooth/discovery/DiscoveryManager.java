...
package impl.myMesh.transport.bluetooth.discovery;
...
import impl.myMesh.transport.bluetooth.BtLink;
import impl.myMesh.transport.bluetooth.BtTransport;
import impl.myMesh.transport.bluetooth.discovery.ble.ManufacturerData;
import impl.myMesh.transport.bluetooth.discovery.ble.scanner.BleScanner;
import impl.myMesh.transport.bluetooth.discovery.ble.advertiser.BleAdvertiser;
import impl.myMesh.transport.bluetooth.discovery.classic.BtScanner;
import impl.myMesh.transport.bluetooth.discovery.idle.IdleAdvertiser;
