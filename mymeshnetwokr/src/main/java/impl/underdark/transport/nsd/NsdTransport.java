...
package impl.myMesh.transport.nsd;
...
import impl.myMesh.transport.nsd.manager.BonjourResolver;
import impl.myMesh.transport.nsd.manager.JmdResolver;
		...
		Transport, WifiDetector.Listener, BonjourResolver.Listener, NsdServer.Listener
{
	...
	)
	{
		...
		serviceType = "_myMesh1-app" + appId + "._tcp.";
	...
	private void startInternal()
	{
		...
		wifiLock = wMgr.createWifiLock(WifiManager.WIFI_MODE_FULL, "myMeshWifiLock");
		wifiLock.acquire();*/
